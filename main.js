...
// PUT/PATCH REQUEST
function updateTodo() {
  // axios.put('https://jsonplaceholder.typicode.com/todos/1',   //replace everything
  //   {title: 'updated todo',
  //   completed: true}
  //   )
  //   .then(res => showOutput(res))
  ...
  axios.patch('https://jsonplaceholder.typicode.com/todos/1', //replace what is specified
      {
        title: 'updated todo',
        completed: true
      }
...
// DELETE REQUEST 
function removeTodo() {
  axios.delete('https://jsonplaceholder.typicode.com/todos/1', //returns empty object
      {
        title: 'updated todo',
        completed: true
      }
